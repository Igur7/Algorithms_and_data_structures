...
def ullmann_v3(used_columns, current_row, M, P_matrix, G_matrix, isomorphisms, calls=0):
    calls += 1
    
    prune(M, P_matrix, G_matrix)  
...
if __name__ == "__main__":
    ...
    M0 = create_M0(P.matrix, G.matrix)
    isomorphisms_v3 = []
    calls_v3 = ullmann_v3([False] * G.matrix.size()[0],0,M0,P.matrix,G.matrix,isomorphisms_v3)

print(len(isomorphisms_v3), calls_v3)
